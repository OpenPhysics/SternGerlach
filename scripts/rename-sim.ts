...
const REPLACEMENTS: ReadonlyArray<[string, string]> = [
  ...
  ["SternGerlachScreenSummaryContent", `${newPrefix}ScreenSummaryContent`],
  ["SternGerlachKeyboardHelpContent", `${newPrefix}KeyboardHelpContent`],
  ["SternGerlachPreferencesModel", `${newPrefix}PreferencesModel`],
  ["SternGerlachPreferencesNode", `${newPrefix}PreferencesNode`],
  ["SternGerlachScreenView", `${newPrefix}ScreenView`],
  ["SternGerlachColors", `${newPrefix}Colors`],
  ["SternGerlachNamespace", `${newPrefix}Namespace`],
  ["SternGerlachScreen", `${newPrefix}Screen`],
  ["SternGerlachModel", `${newPrefix}Model`],
  // camelCase identifier
  ["sternGerlachQueryParameters", `${newCamel}QueryParameters`],
  // Display strings
  ["Stern Gerlach", newName],
  // Kebab identifiers (path segments and package name)
  ["stern-gerlach", newId],
  ["stern-gerlach-screen", `${newId}-screen`],
];
...
console.log(`  id:     stern-gerlach → ${newId}`);
console.log(`  name:   Stern Gerlach → ${newName}`);
